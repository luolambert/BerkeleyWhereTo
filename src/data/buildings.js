export const buildings = [
  ...
  { id: 'leconte', name: 'LeConte Hall (Physics)', lat: 37.8729, lng: -122.2572, category: 'STEM', popular: true, undergrad: true, grad: true },
  ...
  { id: 'lks', name: 'Li Ka Shing Center (LKS)', lat: 37.8730, lng: -122.2653, category: 'STEM', popular: false, undergrad: true, grad: true },
  ...
  { id: 'hearst_mining', name: 'Hearst Memorial Mining Building', lat: 37.8739, lng: -122.2566, category: 'STEM', popular: false, undergrad: true, grad: true },
  ...
  { id: 'social_sciences', name: 'Social Sciences Building', lat: 37.8701, lng: -122.2579, category: 'Humanities', popular: true, undergrad: true, grad: true },
  { id: 'aapb', name: 'Anth & Art Practice (AAPB)', lat: 37.8700, lng: -122.2552, category: 'Arts & Design', popular: false, undergrad: true, grad: true },
  ...
  { id: 'chou', name: 'Chou Hall', lat: 37.8720, lng: -122.2539, category: 'Business', popular: false, undergrad: true, grad: true },
  ...
  { id: 'doe', name: 'Doe Library', lat: 37.8721, lng: -122.2593, category: 'Libraries', popular: true, undergrad: true, grad: true },
  ...
  // Campus Life
  { id: 'rsf', name: 'Recreational Sports Facility (RSF)', lat: 37.8686, lng: -122.2627, category: 'Campus Life', popular: true, undergrad: true, grad: true },
  { id: 'mlk', name: 'Martin Luther King Jr. Student Union', lat: 37.8692, lng: -122.2597, category: 'Campus Life', popular: true, undergrad: true, grad: true },
  { id: 'sproul', name: 'Sproul Hall', lat: 37.8696, lng: -122.2591, category: 'Campus Life', popular: true, undergrad: true, grad: true },
];